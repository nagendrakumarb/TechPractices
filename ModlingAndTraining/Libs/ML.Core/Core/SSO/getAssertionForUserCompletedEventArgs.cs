...
// Type: ML.Core.SSO.getAssertionForUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class getAssertionForUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getAssertionForUserCompletedEventArgs(
      object[] results,
