...
// Type: ML.Core.SSO.deleteFederationMapCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void deleteFederationMapCompletedEventHandler(
    object sender,
    deleteFederationMapCompletedEventArgs e);
}
