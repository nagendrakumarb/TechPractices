...
// Type: ML.Core.SSO.modifyDirectoryIntegrationCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void modifyDirectoryIntegrationCompletedEventHandler(
    object sender,
    modifyDirectoryIntegrationCompletedEventArgs e);
}
