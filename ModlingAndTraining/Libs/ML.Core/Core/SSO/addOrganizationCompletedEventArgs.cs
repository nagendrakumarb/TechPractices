...
// Type: ML.Core.SSO.addOrganizationCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class addOrganizationCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal addOrganizationCompletedEventArgs(
      object[] results,
