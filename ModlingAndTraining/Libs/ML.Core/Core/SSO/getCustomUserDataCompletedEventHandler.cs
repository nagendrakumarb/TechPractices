...
// Type: ML.Core.SSO.getCustomUserDataCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getCustomUserDataCompletedEventHandler(
    object sender,
    getCustomUserDataCompletedEventArgs e);
}
