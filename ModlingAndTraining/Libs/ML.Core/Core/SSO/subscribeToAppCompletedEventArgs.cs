...
// Type: ML.Core.SSO.subscribeToAppCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class subscribeToAppCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal subscribeToAppCompletedEventArgs(
      object[] results,
