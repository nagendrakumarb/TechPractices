...
// Type: ML.Core.SSO.getAssertionForUserCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getAssertionForUserCompletedEventHandler(
    object sender,
    getAssertionForUserCompletedEventArgs e);
}
