...
// Type: ML.Core.SSO.deleteServiceProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void deleteServiceProviderCompletedEventHandler(
    object sender,
    deleteServiceProviderCompletedEventArgs e);
}
