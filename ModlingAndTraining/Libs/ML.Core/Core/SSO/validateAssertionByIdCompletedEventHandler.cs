...
// Type: ML.Core.SSO.validateAssertionByIdCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void validateAssertionByIdCompletedEventHandler(
    object sender,
    validateAssertionByIdCompletedEventArgs e);
}
