...
// Type: ML.Core.SSO.addAndActivateUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class addAndActivateUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal addAndActivateUserCompletedEventArgs(
      object[] results,
