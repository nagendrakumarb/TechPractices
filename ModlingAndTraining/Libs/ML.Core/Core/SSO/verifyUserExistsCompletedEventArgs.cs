...
// Type: ML.Core.SSO.verifyUserExistsCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class verifyUserExistsCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal verifyUserExistsCompletedEventArgs(
      object[] results,
