...
// Type: ML.Core.SSO.setCustomUserDataCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void setCustomUserDataCompletedEventHandler(
    object sender,
    setCustomUserDataCompletedEventArgs e);
}
