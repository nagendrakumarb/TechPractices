...
// Type: ML.Core.SSO.addServiceProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void addServiceProviderCompletedEventHandler(
    object sender,
    addServiceProviderCompletedEventArgs e);
}
