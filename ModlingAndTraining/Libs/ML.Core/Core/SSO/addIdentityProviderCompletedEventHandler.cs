...
// Type: ML.Core.SSO.addIdentityProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void addIdentityProviderCompletedEventHandler(
    object sender,
    addIdentityProviderCompletedEventArgs e);
}
