...
// Type: ML.Core.SSO.subscribeUserToAppCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class subscribeUserToAppCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal subscribeUserToAppCompletedEventArgs(
      object[] results,
