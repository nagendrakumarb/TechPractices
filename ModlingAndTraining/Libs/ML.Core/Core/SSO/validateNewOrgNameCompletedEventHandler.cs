...
// Type: ML.Core.SSO.validateNewOrgNameCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void validateNewOrgNameCompletedEventHandler(
    object sender,
    validateNewOrgNameCompletedEventArgs e);
}
