...
// Type: ML.Core.SSO.setApplicationFieldsForUserCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void setApplicationFieldsForUserCompletedEventHandler(
    object sender,
    setApplicationFieldsForUserCompletedEventArgs e);
}
