...
// Type: ML.Core.SSO.getAssertionCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class getAssertionCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getAssertionCompletedEventArgs(
      object[] results,
