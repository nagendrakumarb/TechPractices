...
// Type: ML.Core.SSO.getAssertionForAnyUserCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getAssertionForAnyUserCompletedEventHandler(
    object sender,
    getAssertionForAnyUserCompletedEventArgs e);
}
