...
// Type: ML.Core.SSO.autoEnrollUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class autoEnrollUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal autoEnrollUserCompletedEventArgs(
      object[] results,
