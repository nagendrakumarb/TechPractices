...
// Type: ML.Core.SSO.validateNewOrgNameCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class validateNewOrgNameCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal validateNewOrgNameCompletedEventArgs(
      object[] results,
