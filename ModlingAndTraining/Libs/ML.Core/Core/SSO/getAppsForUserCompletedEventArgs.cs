...
// Type: ML.Core.SSO.getAppsForUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class getAppsForUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getAppsForUserCompletedEventArgs(
      object[] results,
