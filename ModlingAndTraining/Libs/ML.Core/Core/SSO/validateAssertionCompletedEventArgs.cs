...
// Type: ML.Core.SSO.validateAssertionCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class validateAssertionCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal validateAssertionCompletedEventArgs(
      object[] results,
