...
// Type: ML.Core.SSO.setApplicationFieldsCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class setApplicationFieldsCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal setApplicationFieldsCompletedEventArgs(
      object[] results,
