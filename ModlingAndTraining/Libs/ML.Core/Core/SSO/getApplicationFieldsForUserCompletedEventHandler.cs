...
// Type: ML.Core.SSO.getApplicationFieldsForUserCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getApplicationFieldsForUserCompletedEventHandler(
    object sender,
    getApplicationFieldsForUserCompletedEventArgs e);
}
