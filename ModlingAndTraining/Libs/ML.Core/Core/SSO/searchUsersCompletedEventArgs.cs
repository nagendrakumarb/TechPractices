...
// Type: ML.Core.SSO.searchUsersCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class searchUsersCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal searchUsersCompletedEventArgs(
      object[] results,
