...
// Type: ML.Core.SSO.modifyDirectoryIntegrationCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class modifyDirectoryIntegrationCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal modifyDirectoryIntegrationCompletedEventArgs(
      object[] results,
