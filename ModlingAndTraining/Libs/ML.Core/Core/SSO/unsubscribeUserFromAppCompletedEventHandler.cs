...
// Type: ML.Core.SSO.unsubscribeUserFromAppCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void unsubscribeUserFromAppCompletedEventHandler(
    object sender,
    unsubscribeUserFromAppCompletedEventArgs e);
}
