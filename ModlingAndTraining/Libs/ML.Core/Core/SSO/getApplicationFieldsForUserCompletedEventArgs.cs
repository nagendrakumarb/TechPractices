...
// Type: ML.Core.SSO.getApplicationFieldsForUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class getApplicationFieldsForUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getApplicationFieldsForUserCompletedEventArgs(
      object[] results,
