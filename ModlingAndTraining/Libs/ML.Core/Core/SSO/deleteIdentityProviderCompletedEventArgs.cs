...
// Type: ML.Core.SSO.deleteIdentityProviderCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class deleteIdentityProviderCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal deleteIdentityProviderCompletedEventArgs(
      object[] results,
