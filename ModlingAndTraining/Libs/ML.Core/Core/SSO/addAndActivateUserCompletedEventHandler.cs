...
// Type: ML.Core.SSO.addAndActivateUserCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void addAndActivateUserCompletedEventHandler(
    object sender,
    addAndActivateUserCompletedEventArgs e);
}
