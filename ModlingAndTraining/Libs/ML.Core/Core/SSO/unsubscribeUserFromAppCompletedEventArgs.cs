...
// Type: ML.Core.SSO.unsubscribeUserFromAppCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class unsubscribeUserFromAppCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal unsubscribeUserFromAppCompletedEventArgs(
      object[] results,
