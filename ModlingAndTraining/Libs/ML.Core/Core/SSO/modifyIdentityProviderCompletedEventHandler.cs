...
// Type: ML.Core.SSO.modifyIdentityProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void modifyIdentityProviderCompletedEventHandler(
    object sender,
    modifyIdentityProviderCompletedEventArgs e);
}
