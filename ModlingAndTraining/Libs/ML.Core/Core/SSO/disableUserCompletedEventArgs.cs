...
// Type: ML.Core.SSO.disableUserCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class disableUserCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal disableUserCompletedEventArgs(
      object[] results,
