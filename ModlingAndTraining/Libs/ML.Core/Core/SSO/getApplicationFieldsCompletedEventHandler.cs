...
// Type: ML.Core.SSO.getApplicationFieldsCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getApplicationFieldsCompletedEventHandler(
    object sender,
    getApplicationFieldsCompletedEventArgs e);
}
