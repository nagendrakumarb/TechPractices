...
// Type: ML.Core.SSO.deleteFederationMapCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class deleteFederationMapCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal deleteFederationMapCompletedEventArgs(
      object[] results,
