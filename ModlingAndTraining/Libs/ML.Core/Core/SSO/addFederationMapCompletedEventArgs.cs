...
// Type: ML.Core.SSO.addFederationMapCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class addFederationMapCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal addFederationMapCompletedEventArgs(
      object[] results,
