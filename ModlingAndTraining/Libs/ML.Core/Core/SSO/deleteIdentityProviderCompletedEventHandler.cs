...
// Type: ML.Core.SSO.deleteIdentityProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void deleteIdentityProviderCompletedEventHandler(
    object sender,
    deleteIdentityProviderCompletedEventArgs e);
}
