...
// Type: ML.Core.SSO.subscribeUserToAppCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void subscribeUserToAppCompletedEventHandler(
    object sender,
    subscribeUserToAppCompletedEventArgs e);
}
