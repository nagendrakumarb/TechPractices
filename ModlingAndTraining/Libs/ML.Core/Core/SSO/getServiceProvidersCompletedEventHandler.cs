...
// Type: ML.Core.SSO.getServiceProvidersCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getServiceProvidersCompletedEventHandler(
    object sender,
    getServiceProvidersCompletedEventArgs e);
}
