...
// Type: ML.Core.SSO.validateAssertionByNameCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void validateAssertionByNameCompletedEventHandler(
    object sender,
    validateAssertionByNameCompletedEventArgs e);
}
