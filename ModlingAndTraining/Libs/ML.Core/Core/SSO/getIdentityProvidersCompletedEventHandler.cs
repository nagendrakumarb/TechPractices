...
// Type: ML.Core.SSO.getIdentityProvidersCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getIdentityProvidersCompletedEventHandler(
    object sender,
    getIdentityProvidersCompletedEventArgs e);
}
