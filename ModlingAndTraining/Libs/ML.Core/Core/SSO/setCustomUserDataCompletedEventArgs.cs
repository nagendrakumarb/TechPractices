...
// Type: ML.Core.SSO.setCustomUserDataCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class setCustomUserDataCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal setCustomUserDataCompletedEventArgs(
      object[] results,
