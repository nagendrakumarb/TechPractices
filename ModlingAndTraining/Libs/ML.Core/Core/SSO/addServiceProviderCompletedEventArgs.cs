...
// Type: ML.Core.SSO.addServiceProviderCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class addServiceProviderCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal addServiceProviderCompletedEventArgs(
      object[] results,
