...
// Type: ML.Core.SSO.getAssertionForAnyUserWithAttributesCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class getAssertionForAnyUserWithAttributesCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getAssertionForAnyUserWithAttributesCompletedEventArgs(
      object[] results,
