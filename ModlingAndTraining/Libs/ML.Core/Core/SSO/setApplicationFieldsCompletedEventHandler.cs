...
// Type: ML.Core.SSO.setApplicationFieldsCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void setApplicationFieldsCompletedEventHandler(
    object sender,
    setApplicationFieldsCompletedEventArgs e);
}
