...
// Type: ML.Core.SSO.validateAssertionCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void validateAssertionCompletedEventHandler(
    object sender,
    validateAssertionCompletedEventArgs e);
}
