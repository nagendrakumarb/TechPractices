...
// Type: ML.Core.SSO.modifyServiceProviderCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void modifyServiceProviderCompletedEventHandler(
    object sender,
    modifyServiceProviderCompletedEventArgs e);
}
