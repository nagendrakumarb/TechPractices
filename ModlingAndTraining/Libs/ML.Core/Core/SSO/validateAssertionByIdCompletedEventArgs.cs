...
// Type: ML.Core.SSO.validateAssertionByIdCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class validateAssertionByIdCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal validateAssertionByIdCompletedEventArgs(
      object[] results,
