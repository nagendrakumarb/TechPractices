...
// Type: ML.Core.SSO.unsubscribeFromAppCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void unsubscribeFromAppCompletedEventHandler(
    object sender,
    unsubscribeFromAppCompletedEventArgs e);
}
