...
// Type: ML.Core.SSO.unsubscribeFromAppCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class unsubscribeFromAppCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal unsubscribeFromAppCompletedEventArgs(
      object[] results,
