...
// Type: ML.Core.SSO.addIdentityProviderCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  [DebuggerStepThrough]
  public class addIdentityProviderCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal addIdentityProviderCompletedEventArgs(
      object[] results,
