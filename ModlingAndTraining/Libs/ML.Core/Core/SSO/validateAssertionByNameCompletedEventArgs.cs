...
// Type: ML.Core.SSO.validateAssertionByNameCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class validateAssertionByNameCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal validateAssertionByNameCompletedEventArgs(
      object[] results,
