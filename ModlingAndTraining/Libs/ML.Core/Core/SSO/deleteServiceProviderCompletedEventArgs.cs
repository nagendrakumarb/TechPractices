...
// Type: ML.Core.SSO.deleteServiceProviderCompletedEventArgs
...
namespace ML.Core.SSO
{
  ...
  public class deleteServiceProviderCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal deleteServiceProviderCompletedEventArgs(
      object[] results,
