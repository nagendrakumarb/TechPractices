...
// Type: ML.Core.SSO.getCaptchaSessionCompletedEventHandler
...
namespace ML.Core.SSO
{
  ...
  public delegate void getCaptchaSessionCompletedEventHandler(
    object sender,
    getCaptchaSessionCompletedEventArgs e);
}
